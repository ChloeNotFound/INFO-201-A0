...
has_more_zs <- function(s1,s2) {
  s1<-tolower(s1)
  s2<-tolower(s2)
  s1_count <- str_count(s1,"z")
  s2_count <- str_count(s2,"z")
...
fluidConversion <- function(fluidOz) {
...
print(movies <- c("Iron Man", "The Avengers", "Spider-Man", "Frozen", "Coco","Joker")) 
